...
echo -ne "\r\e[K"
echo -e "\u2705 Installing CLI tools done!"

# Install MLIR
echo -n "Cloning MLIR"
git clone --depth 1 https://github.com/llvm/llvm-project &> $out
echo -ne "\r\e[K"
echo -e "\u2705 Cloning MLIR done!"
...
then
    echo -ne "\r\e[K"
    echo -e "\u2705 Testing MLIR passed!"
else
    echo -ne "\r\e[K"
    echo -e "\u274c Testing MLIR failed!"
fi
...
then
    echo -ne "\r\e[K"
    echo -e "\u2705 Testing SDIR passed!"
else
    echo -ne "\r\e[K"
    echo -e "\u274c Testing SDIR failed!"
fi
